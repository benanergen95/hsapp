    ...
    <h2 class="av1">Height  <span class="text-muted"></span></h2>
        ...
        <div class="parMain">
          ...
          <hr>
            <div class="av1">
              <form>
                <button onclick="location.href = 'WeightBMI1'" type="button" class="btn btn-outline-secondary btn-lg mr-5">Back</button>

                <a href="WeightBMI3" type="button" class="btn btn-primary btn-lg ml-5">Next</a>
              </form>
            </div>  
      </div>
