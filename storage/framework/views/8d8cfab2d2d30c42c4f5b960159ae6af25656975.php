    ...
    <?php endif; ?>
      ...
      <form action="<?php echo e(url('Register')); ?>" method="post">
        ...
        <div class="form-group">
          ...
          <p class="">Are you a?</p>
          <div >
            <input type="radio" name="type" id="option1" autocomplete="off" onclick="myFunction()" value="Mum" > Mum
         
            <input type="radio" name="type" id="option2" autocomplete="off" onclick="myFunction()" value="Dad" > Dad
       
            <input type="radio" name="type" id="option3" autocomplete="off" onclick="myFunction()" value="Other"  > Other
          </div>
