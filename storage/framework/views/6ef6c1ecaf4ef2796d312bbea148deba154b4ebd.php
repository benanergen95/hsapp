        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo e(url('editexercise2')); ?>" method="post">
                        <div class="jumbotron bg-gery rounded-top rounded-bottom border border-secondry mx-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <button type="button" class="btn btn-light"
                                                onclick=" window.open('<?php echo e($data); ?>','_blank')">Find out more
                                        </button>
                                    </div>
                                </div>
                                <div class="text-center">
                                    Link:
                                    <input type="text" name="linke1" class="form-control" value="<?php echo e($data); ?>">
                                </div>
                            ...
                            <div class="fAlert alert-colBox" role="alert">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <button type="button" class="btn btn-light"
                                                onclick=" window.open('<?php echo e($data1); ?>','_blank')">Find out more
                                        </button>
                                    </div>
                                </div>
                                <div class="text-center">
                                    Link:
                                    <input type="text" name="linke2" class="form-control" value="<?php echo e($data1); ?>">
                                </div>
                            </div><!--Blue thing div-->
                            ...
                            <div class="fAlert alert-colBox1" role="alert">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <button type="button" class="btn btn-light"
                                                onclick=" window.open('<?php echo e($data2); ?>','_blank')">Find out more
                                        </button>
                                    </div>
                                </div>
                                <div class="text-center">
                                    Link:
                                    <input type="text" class="form-control" name="linke3" value="<?php echo e($data2); ?>">
                                </div>
                            </div>
