  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.9/summernote-bs4.js"></script>
      <div class="BOXtears">
        <h2 class="text-center">Diet 0 page<span class="text-muted"></span></h2>

        <hr>
        <?php
    $data=DB::table('summernotes')->where("item_id","=",7)->value('content'); //
    ?>
        <div class="container">
         <div class="panel panel-default"> 
          ...
          <div class="panel-body">
            ...
            <form action="<?php echo e(url('editdiet0')); ?>" method="post" >
              <div class="form-group">
                <textarea id="summernote" name="editdiet0value" class="form-control">
                  <?php echo $data; ?>
          ...
          <div class="av1"> 
            ...
            <!-- show how data will look after stored-->
                    <?php echo $data; ?>
