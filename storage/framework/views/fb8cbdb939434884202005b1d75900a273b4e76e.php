...
<?php echo $__env->make('layouts.navAdminedit', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.9/summernote-bs4.js"></script>
      ...
      <div class="BOXtears">
        <h2 class="text-center">Sleep 1 page<span class="text-muted"></span></h2>
        ...
        <div class="container">
         <div class="panel panel-default"> 
          ...
          <div class="panel-body">
            ...
            <form action="<?php echo e(url('editsleep3')); ?>" method="post" >
            	 <?php echo csrf_field(); ?>

              <div class="form-group">
                <textarea id="summernote" name="eslp31" class="form-control">
                  <?php echo $data; ?>

                </textarea>
          <div class="text-center"><p><b>Input</b></p></div>
              
                <textarea id="summernote2" name="eslp32" class="form-control">
                  <?php echo $data2; ?>

                </textarea>
                          <div class="text-center"><p><b>Input</b></p></div>
                 <textarea id="summernote3" name="eslp33" class="form-control">
                  <?php echo $data3; ?>
