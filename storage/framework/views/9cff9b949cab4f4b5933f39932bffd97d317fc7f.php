        ...
        <div class="container">
         <div class="panel panel-default"> 
          ...
          <div class="panel-body">
            ...
            <form action="<?php echo e(url('editscreentime4')); ?>" method="post" >
      <div class="jumbotron bg-gery rounded-top rounded-bottom border border-secondry mx-2">
        ...
        <div class="fAlert alert-colBox2" role="alert">
          ...
          <div class="row">
           ...
           Link:
            <input type="text" name="linkst1" class="form-control" value="<?php echo e($data); ?>">
            </div>
        ...
        <div class="fAlert alert-colBox" role="alert">
          <!-- Stack the columns on mobile by making one full-width and the other half-width -->
           ...
           <div class="text-center" >
           Link:
            <input type="text" name="linkst2" class="form-control" value="<?php echo e($data1); ?>">
            </div>
        </div><!--Blue thing div-->
        ...
        <div class="fAlert alert-colBox1" role="alert">
          ...
          <div class="row">
           ...
           <div class="text-center" >
           Link:
            <input type="text" class="form-control" name="linkst3" value="<?php echo e($data2); ?>">
            </div>
             </div>
