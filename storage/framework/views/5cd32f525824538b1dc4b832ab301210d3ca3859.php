...
<?php $__env->startSection('content'); ?>
    ...
    <div class="BOXtears">
        <h2 class="text-center">Diet 2 page<span class="text-muted"></span></h2>
        <hr>
        <?php
            $data=DB::table('summernotes')->where("item_id","=",9)->value('content');
        ?>
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo e(url('editdiet2')); ?>" method="post">
                        <div class="form-group">
                <textarea id="summernote" name="editdiet2value" class="form-control">
                  <?php echo $data; ?>
