  ...
  <?php $__env->startSection('content'); ?>
    ...
    <main role="main" class="container">
      ...
      <div>
       ...
       <h2 class="av1">Non-Registed Users<span class="text-muted"></span></h2>
    <div class="panel-body">
     ...
     <?php $__currentLoopData = $nonRegistredusers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nuser => $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        ...
        <td>
             <a href="<?php echo e(url('deletemail',array($email->email))); ?>">
              Delete</a>
        </td>
...
<h2 class="av1">Registed Users<span class="text-muted"></span></h2>
    <div class="panel-body">
