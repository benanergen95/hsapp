  ...
  <?php $__env->startSection('content'); ?>
    ...
    <!---->
      ...
      <div class="BOXtears">
        ...
        <div class="parMain">
          <div class="row justify-content-center  text-white">
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-6 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($results->RBmi == 0 ? "Normal Weight" : ($$results->RBmi == 1 ? "Under Weight" : "Overweight")); ?></div>
        ...
        <br>
        <h5 class="text-left text-success">Detailed Report</h5>
        <div class="parMain">

          <div class="row justify-content-center  text-white">
              <div class="col-6 lead bg-secondary">Fruit and Vegtable intake</div>
              <div class="col-6 lead bg-secondary">Result</div>
            </div>
            <div class="row justify-content-center">
              <div class="col-6 text-black lead border border-secondary" style="background-color:#e4e6e7">Fruit</div>
              <div class="col-6 text-black lead  border border-secondary" style="background-color:#e4e6e7">Sufficient</div>
              <div class="col-6 text-black lead border border-secondary" style="background-color:#e4e6e7">Vegtable intake</div>
              <div class="col-6 text-black lead  border border-secondary" style="background-color:#e4e6e7">Not Enough</div>
            </div>
        </div>
        <hr>
          <div class="av1"> 
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <button type="button" class="btn btn-primary btn-sm">Use my account Email</button>
            <form>
