  ...
  <?php $__env->startSection('content'); ?> 
			...
			<div class="row">
				<div class="col align-self-center">
					...
					<img id="physicalPic" class="img-fluid" 
						src="<?php echo e(asset('/content/Exercise-Result.jpg')); ?>?<?php echo e(time()); ?>" width="600px" 
    ...
    <!-- /Start NAV Buttons -->
    	<div class="av1">
			<form>
				<button onclick="location.href = 'Exercise3'" type="button" class="btn btn-primary btn-lg ml-5">Next</button>
			</form>
		</div>	
	</div><!-- /.container -->
