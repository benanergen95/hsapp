      ...
      <div class="jumbotron bg-white rounded-top rounded-bottom border border-secondry mx-2">
        ...
        <div class="parMain">
          <div class="row justify-content-center  text-white">
              <div class="col-3 lead bg-secondary">Test</div>
              <div class="col-2 lead bg-secondary">Result</div>
              <div class="col-2 lead bg-secondary">Values</div>
               <div class="col-5 lead bg-secondary">Recommended</div>
            </div>
            <div class="row justify-content-center">
              <!-- Weight result-->
              <div class="col-3 text-black lead border border-secondary" style="background-color:#e4e6e7">Weight Body Mass Index</div>
              <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($results->RBmi == 1 ? $data2 : ($results->RBmi == 0 ? $data1 : $data3)); ?></div>
                <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($entries->BMI_v); ?></div>
              ...
              <div class="col-3 text-black lead border border-secondary" style="background-color:#e4e6e7">Fruit Intake</div>
              <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($results->RfruitsIntake == 0 ? $data1f : $data2f); ?></div>
              <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($entries->fruits); ?></div>
              <div class="col-5 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($recommendedF); ?></div>
              <div class="col-3 text-black lead border border-secondary" style="background-color:#e4e6e7">Veggies Intake</div>
              <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($results->RveggiesIntake == 0 ? $data1v :  $data2v); ?></div>
              <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($entries->veggies); ?></div>
               <div class="col-5 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($recommendedV); ?></div>       

              <!-- Exercise result-->
              <div class="col-3 text-black lead border border-secondary" style="background-color:#e4e6e7">Exercise</div>
              <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($results->Rexercise == 0 ? $data1e : $data2e); ?></div>
              ...
              <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e(date('H:i', strtotime($entries->exercise))); ?></div>
               <div class="col-5 text-black lead  border border-secondary" style="background-color:#e4e6e7">Exercise more than 60 minutes</div>       

              <!-- Screen time result-->
              <div class="col-3 text-black lead border border-secondary" style="background-color:#e4e6e7">Screen time School Days</div>
              <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($results->RscreentimeSD == 0 ? $data1st : $data2st); ?></div>
              ...
              <div class="col-5 text-black lead  border border-secondary" style="background-color:#e4e6e7"> Less than 2 hours</div>    
              <div class="col-3 text-black lead border border-secondary" style="background-color:#e4e6e7">Screen time Non-School Days</div>
              <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($results->RscreentimeNSD == 0 ? $data3st : $data4st); ?></div>
              ...
              <div class="col-3 text-black lead border border-secondary" style="background-color:#e4e6e7">Sleep School Days</div>
              <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($results->RStimeSD == 0 ? $data1slp : ($results->RStimeSD == 1 ? $data2slp : $data5slp)); ?></div>
              ...
              <div class="col-3 text-black lead border border-secondary" style="background-color:#e4e6e7">Sleep Non-School Days</div>
              <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($results->RStimeNSD == 0 ? $data3slp : ($results->RStimeNSD == 1 ? $data4slp : $data6slp)); ?></div>
        ...
        <hr>
          <div class="av1"> 
            ...
            <a href="ChildRegistration" type="button" class="btn btn-primary">Start New</a>
            <hr>
            <a href="Tests" type="button" class="btn btn-primary">Home</a>
          </div>
          <hr>
 ...
 <div class="row justify-content-center">
            ...
            <form action="<?php echo e(url('csend')); ?>">
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Email@domain.com">
              </div>
