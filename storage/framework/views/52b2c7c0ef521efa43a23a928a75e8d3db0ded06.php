  ...
  <?php $__env->startSection('content'); ?>
    ...
    <?php
    	...
    	elseif ($screenSD  == 0 && $screenNSD  == 1)
    	{
    		...
    		", has balanced screen time during the school days. However, they are spending too much time on the screen during NON-school days!";
    	}
    	elseif ($screenSD  == 1 && $screenNSD  == 0)
    	{
    		$finalMessage = "Great Job! Your Child, ".$child->CfName." ".$child->ClName.
    		", has balanced screen time during the NON-school days. However, they are spending too much time on the screen during school days!";
    	}
    	else
    	{
    		$finalMessage = "Keep trying! Your Child, ".$child->CfName." ".$child->ClName.
	...
	?> 
				...
				<div class="row">
					<div class="col align-self-center">
						...
						<img id="sedentaryPic" class="img-fluid" 
							src="<?php echo e(asset('/content/Screen-Result.jpg')); ?>?<?php echo e(time()); ?>" 
							alt="Generic placeholder image" width="600px">	
					</div>	
				</div>
				<hr>
			</div>
    	...
    	<div class="av1">
			<form>
			 	<button class="btn btn-primary btn-lg ml-5" type="button" onclick="location.href = 'ScreenTime5'">
                  Next
              	</button>
			</form>
		</div>	
