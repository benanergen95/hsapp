...
<body>
<p>Hi {{ $pname }}, these are the results of your child {{ $cname }}.</p>
<h2>Results</h2>
...
<table>
    ...
    <tr>
        <td>Weight</td>
        <td>{{  $results->RBmi == 1 ? $data2 : ($results->RBmi == 0 ? $data1 : $data3) }}</td>
    </tr>
    <tr>
        <td>Fruit Intake</td>
        <td>{{  $results->RfruitsIntake == 0 ? $data1f : $data2f }}</td>
    </tr>
    <tr>
        <td>Veggies Intake</td>
        <td>{{  $results->RveggiesIntake == 0 ? $data1v :  $data2v }}</td>

    </tr>
    <tr>
        <td>Exercise</td>
        <td>{{  $results->Rexercise == 0 ? $data1e : $data2e }}</td>
    </tr>
    <tr>
        <td>Screen time School Days</td>
        <td>{{  $results->RscreentimeSD == 0 ? $data1st : $data2st }}</td>
    </tr>
    <tr>
        <td>Screen time Non-School Days</td>
        <td>{{  $results->RscreentimeNSD == 0 ? $data3st : $data4st }}</td>
    </tr>
    <tr>
        <td>Sleep School Days</td>
        <td>{{  $results->RStimeSD == 0 ? $data1slp : ($results->RStimeSD == 1 ? $data2slp : $data5slp) }}</td>
    </tr>
    <tr>
        <td>Sleep Non-School Days</td>
        <td>{{  $results->RStimeNSD == 0 ? $data3slp : ($results->RStimeNSD == 1 ? $data4slp : $data6slp) }}</td>
    </tr>
</table>
<br>
<div align="center">
