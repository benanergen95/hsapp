...
@section('content')
    ...
    <div class="jumbotron bg-white rounded-top rounded-bottom border border-secondry mx-2">
        ...
        <div class="parMain">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col text-black lead  border border-secondary"
                     style="background-color:#e4e6e7">{{  $results->RBmi == 1 ? $data2 : ($results->RBmi == 0 ? $data1 : $data3) }}</div>
            <!--   <div class="col text-black lead  border border-secondary" style="background-color:#e4e6e7">{{  $entries->BMI_v}}</div> -->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col text-black lead  border border-secondary"
                     style="background-color:#e4e6e7">{{  $results->RfruitsIntake == 0 ? $data1f : $data2f }}</div>
            <!--     <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7">{{  $entries->fruits}}</div> -->
                <div class="col text-black lead  border border-secondary"
            ...
            <div class="row justify-content-center">
                ...
                <div class="col text-black lead  border border-secondary"
                     style="background-color:#e4e6e7">{{  $results->RveggiesIntake == 0 ? $data1v :  $data2v }}</div>
            <!--   <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7">{{  $entries->veggies}}</div> -->
                <div class="col text-black lead  border border-secondary"
        ...
        <div class="row justify-content-center">
            ...
            <div class="col text-black lead  border border-secondary"
                 style="background-color:#e4e6e7">{{  $results->Rexercise == 0 ? $data1e : $data2e }}</div>

        <!--     <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7">{{date('H:i', strtotime($entries->exercise))}}</div> -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="col text-black lead  border border-secondary"
                 style="background-color:#e4e6e7">{{  $results->RscreentimeSD == 0 ? $data1st : $data2st }}</div>
        <!--    <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7">{{  $entries->screenTimeSD}}</div> -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="col text-black lead  border border-secondary"
                 style="background-color:#e4e6e7">{{  $results->RscreentimeNSD == 0 ? $data3st : $data4st }}</div>
        <!--    <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7">{{  $entries->screenTimeNSD}}</div> -->
            <div class="col text-black lead  border border-secondary" style="background-color:#e4e6e7"> Less than 2
                hours
            </div>
            <!-- Sleep result-->
        ...
        <div class="row justify-content-center">
            ...
            <div class="col text-black lead  border border-secondary"
                 style="background-color:#e4e6e7">{{  $results->RStimeSD == 0 ? $data1slp : ($results->RStimeSD == 1 ? $data2slp : $data5slp) }}</div>
        <!--     <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7">{{ date('H:i', strtotime($entries->sleepSD))}}</div> -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="col text-black lead  border border-secondary"
                 style="background-color:#e4e6e7">{{  $results->RStimeNSD == 0 ? $data3slp : ($results->RStimeNSD == 1 ? $data4slp : $data6slp) }}</div>
        <!--     <div class="col-2 text-black lead  border border-secondary" style="background-color:#e4e6e7">{{ date('H:i', strtotime($entries->sleepNSD))}}</div> -->
            <div class="col text-black lead  border border-secondary" style="background-color:#e4e6e7">Between 9 & 11
                hours
            </div>
        </div>
