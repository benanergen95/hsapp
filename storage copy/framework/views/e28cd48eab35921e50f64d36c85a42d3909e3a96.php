...
<?php $__env->startSection('content'); ?>
    ...
    <div class="BOXtears">
        <h2 class="text-center">Screentime 0 page<span class="text-muted"></span></h2>
        <hr>
        <?php
        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo e(url('editscreentime0')); ?>" method="post">
                        <div class="form-group">
                <textarea id="summernote" name="editscreentime0value" class="form-control">
                  <?php echo $data; ?>
