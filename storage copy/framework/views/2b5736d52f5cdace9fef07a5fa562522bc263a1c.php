            ...
            <div class="parMain">
                ...
                <div class="form-group">
                    ...
                    <input name="firstname" type="text" class="form-control" id="FormControlInput1"
                           placeholder="First Name" value="<?php echo e(old('firstname')); ?>">
                    ...
                    <input name="lastname" type="text" class="form-control" id="FormControlInput2"
                           placeholder="Last Name" value="<?php echo e(old('lastname')); ?>">
                ...
                <div class="form-group">
                    ...
                    <div id="myP" style="display:none;">
                        ...
                        <input type="text" name='other-type' class="form-control" id="FormControlInput3"
                               placeholder="If we require a text field for this it will only come up when the parent selected other." value="<?php echo e(old('other-type')); ?>">
                    </div>
                </div>
                <div class="form-group">
                    <!-- Email Input-->
                    ...
                    <input type="email" name="email" class="form-control" id="FormControlInput4"
                           aria-describedby="emailHelp" placeholder="Email@example.com" value="<?php echo e(old('email')); ?>">
                </div>
                <div class="form-group">
                    <!-- Password Input-->
