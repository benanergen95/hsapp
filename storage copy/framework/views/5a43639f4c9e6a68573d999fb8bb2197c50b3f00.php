      ...
      <div class="container text-center">
        <div class="row">
          <div class="col align-self-center">
            <h3 class="featurette-heading text-success">Vegetables <span class="text-muted"></span></h3>
            <div>
              <p class="lead">How many serves of vegetables does your child usually eat each day?</p>
              <p class="lead">A serve is 1/2 cup cooked vegetables, or 1 cup of salad vegetables. Include fresh, dried, frozen and tinned vegetables. </p>
              <div>
                <img id="serve-veggies" class="img-fluid" 
                src="./content/serve-veggies.png" 
