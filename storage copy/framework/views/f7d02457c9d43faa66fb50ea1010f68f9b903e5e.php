...
<?php $__env->startSection('content'); ?>
    ...
    <div class="BOXtears">
        <h2 class="text-center">Exercise 0 page<span class="text-muted"></span></h2>
        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo e(url('editexercise0')); ?>" method="post">
                        <div class="form-group">
                <textarea id="summernote" name="editexercise0value" class="form-control">
                  <?php echo $data; ?>
