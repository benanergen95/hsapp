			...
			<div class="row">
				<div class="col align-self-center">
					...
					<img id="physicalPic" class="img-fluid" 
						src="<?php echo e(asset('/content/Physical-Introduction.jpg')); ?>?<?php echo e(time()); ?>" 
    ...
    <!-- /Start Nav Buttons -->
		<div class="av1">
			<form>
				...
				<button onclick="location.href = 'PhysicalActivity1'" type="button" class="btn btn-primary btn-lg ml-5">Next</button>
			</form>
		</div>	
	</div><!-- /.container -->
<?php $__env->stopSection(); ?>
