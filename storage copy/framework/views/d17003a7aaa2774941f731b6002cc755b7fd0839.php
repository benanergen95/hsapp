...
<?php echo $__env->make('layouts.navAdminedit', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.9/summernote-bs4.js"></script>
      <div class="BOXtears">
        <h2 class="text-center">Weight 3 page<span class="text-muted"></span></h2>
        <hr>
        <?php
        ...
        <div class="container">
         <div class="panel panel-default"> 
          ...
          <div class="panel-body">
            <form action="<?php echo e(url('editweight3')); ?>" method="post" >
              <div class="form-group">
                <textarea id="summernote" name="editweight3value" class="form-control">
                  <?php echo $data; ?>
