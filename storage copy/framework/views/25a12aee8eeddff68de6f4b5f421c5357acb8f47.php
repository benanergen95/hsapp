                    ...
                    <form action="<?php echo e(url('editsleep2')); ?>" method="post">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-4 text-black lead  border border-secondary"
                                 style="background-color:#e4e6e7"><?php echo e($data1); ?></div>
                            <div class="col-4 text-black lead border border-secondary"
                                 style="background-color:#e4e6e7"><?php echo e($data3); ?></div>
                            <div class="col-4 text-black lead  border border-secondary"
                                 style="background-color:#e4e6e7">text if not having enough sleep
                            </div>
                            <div class="col-4 text-black lead border border-secondary"
                                 style="background-color:#e4e6e7"><?php echo e($data2); ?></div>
                            <div class="col-4 text-black lead  border border-secondary"
                                 style="background-color:#e4e6e7"><?php echo e($data4); ?></div>
                            <div class="col-4 text-black lead  border border-secondary"
                                 style="background-color:#e4e6e7">text if having too much sleep
                            </div>
                            <div class="col-4 text-black lead border border-secondary"
                                 style="background-color:#e4e6e7"><?php echo e($data6); ?></div>
                            <div class="col-4 text-black lead  border border-secondary"
                                 style="background-color:#e4e6e7"><?php echo e($data7); ?></div>
                        </div>
                        <hr>
