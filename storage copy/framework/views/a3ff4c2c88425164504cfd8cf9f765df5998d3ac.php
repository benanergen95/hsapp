...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Begin page content -->
    <div class="BOXtears">
        <h2 class="text-center">Weight 0 page<span class="text-muted"></span></h2>
        <hr>
        <?php
        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo e(url('editweight0')); ?>" method="post">
                        <div class="form-group">
                <textarea id="summernote" name="editweight0value" class="form-control">
                  <?php echo $data; ?>
