  ...
  <?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>  							
        ...
        <!-- Start NAV Buttons -->
        	<div class="av1">
				<form>
					<button onclick="location.href = 'Sedentary0'" type="button" class="btn btn-outline-secondary btn-lg mr-5">Back</button>
   				 	<button class="btn btn-primary btn-lg ml-5" type="button" onclick="location.href = 'Sedentary2'">
                  Next
              	</button>
				</form>
			</div>	
