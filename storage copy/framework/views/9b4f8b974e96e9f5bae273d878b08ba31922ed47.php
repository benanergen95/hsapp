      ...
      <div class="jumbotron bg-white rounded-bottom border border-primary mx-4">
        ...
        <picture>
          <div class="text-center">
            <img id="scale-1"src="<?php echo e(asset('/content/scale-403585_1920.jpg')); ?>?<?php echo e(time()); ?>" class="picScale3" alt="Scale">
          ...
          <hr>
            ...
            <form>
              <button onclick="location.href = 'Tests'" type="button" class="btn btn-outline-secondary btn-lg mr-5">Back</button>
                ...
                <a href="Weight1" type="button" class="btn btn-primary btn-lg ml-5">Next</a>
            </form>
          </div>  
      </div>
  <?php $__env->stopSection(); ?>
