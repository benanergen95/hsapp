        ...
        <div class="container text-center">
            <div class="row">
                <div class="col align-self-center">
                    ...
                    <p class="lead"><?php echo e($fname); ?>, <?php echo e($data); ?> <?php echo e($BMIr); ?> with Bmi z-score value of <?php echo e($zBMI); ?>.</p>
                    <div class="row justify-content-center  text-white">
                    ...
                    <div class="row justify-content-center">
                        <div class="col text-black lead  border border-secondary"
                             style="background-color:#e4e6e7"><?php echo e($zBMI); ?></div>
