	...
	?> 
		...
		<div class="jumbotron bg-white rounded-bottom border border-info mx-2">			
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-3 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($screenSDv); ?> hours</div>
               ...
               <div class="col-3 text-black lead  border border-secondary" style="background-color:#e4e6e7">Non - School Days </div>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#e4e6e7"><?php echo e($screenNSDv); ?> hours</div>
               <div class="col-5 text-black lead  border border-secondary" style="background-color:#e4e6e7">Less than 2 hours</div>       
            </div>
                    <br>
						<?php echo $data5; ?>
