  ...
  <?php $__env->startSection('content'); ?> 				
			...
			<div class="container text-center">
				<div class="row">
					<div class="col align-self-center">
						<h3 class="featurette-heading text-secondary">Sleep School Days <span class="text-muted"></span></h3>
						<p class="lead">During school days, what time does your child sleep?</p>
						...
						<img id="sleepPic1-1" class="img-fluid" src="<?php echo e(asset('/content/Sleep-Question1.jpg')); ?>?<?php echo e(time()); ?>" alt="Generic placeholder image" width="600">
					</div>	
				</div>
				<hr>
			</div>
        ...
        <!-- /Start NAV Buttons --> 
			<div class="av1">
				<button onclick="location.href = 'Sleep0'" type="button" class="btn btn-outline-secondary btn-lg mr-5">Back</button>
