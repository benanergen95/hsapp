				...
				<div class="row">
					<div class="col align-self-center">
						...
						<img id="sedentaryPic" class="img-fluid pb-3" 
							src="<?php echo e(asset('/content/Sedentary-Introduction.jpg')); ?>?<?php echo e(time()); ?>" 
			...
			<div class="av1">
				<form>
					<button onclick="location.href = 'Tests'" type="button" class="btn btn-outline-secondary btn-lg mr-5">Back</button>
   				 	<button class="btn btn-primary btn-lg ml-5" type="button" onclick="location.href = 'Sedentary1'">
                  Next
              	</button>
				</form>
			</div>		
