...
@section('content')
    ...
    <div class="jumbotron bg-white rounded-bottom border border-info mx-2">
        <form method="post" action="{{url('StoreScreenNSD')}}">
            {{csrf_field()}}
                    ...
                    <div class="col align-self-center">
                        ...
                        <div class="pt-3">
                            <input id="slider" type="number" data-slider-id='sliderID' data-slider-min="0"
                                   data-slider-max="18" data-slider-step="0.5" data-slider-value="3" name="screenNSD"/>
                        </div>
            ...
            <div class="av1">
                <button onclick="location.href = 'ScreenTime2'" type="button"
