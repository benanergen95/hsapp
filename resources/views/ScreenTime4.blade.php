                ...
                <div class="col align-self-center">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 text-black lead border border-info"
                             style="background-color:#b1e0e7">{{$screenSDMessage}}</div>
                        <div class="col-6 text-black lead  border border-info"
                             style="background-color:#b1e0e7">{{$screenNSDMessage}}</div>
                    </div>
                    <br>
                    <div class="row justify-content-center  text-white">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col text-black lead  border border-secondary"
                             style="background-color:#e4e6e7">{{ $screenSDv }} hours
                        </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col text-black lead  border border-secondary"
                             style="background-color:#e4e6e7">{{ $screenNSDv }} hours
                        </div>
                        <div class="col text-black lead  border border-secondary" style="background-color:#e4e6e7">Less
                            than 2 hours
                        </div>
