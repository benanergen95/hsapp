            ...
            <div class="row">
                <div class="col align-self-center">
                    ...
                    <div class="row justify-content-center  text-white">
                        <div class="col-10 lead bg-info py-2" style="background-color:#f4bec3"> {{ $BMIc }}</div>
                        <!-- Well done or getting  -->
                    </div>
                    <p class="lead">{{ $fname }}, {{ $data }} {{ $BMIr }} with Bmi z-score value of {{ $zBMI }}.</p>
                    <div class="row justify-content-center  text-white">
